...
interface FormData {
  ...
  businessType: string;
  location: string;
  mangroveInteraction: string;
  sustainabilityGoals: string;
  customerInterest: string;
}

const TourismIndustryRegistrationForm = () => {
  ...
  return (
    ...
    >
      <div className="block mt-2">
        ...
        {["Resort", "Tour Operator", "Association"].map((option) => (
      ...
      <label className="block font-semibold mb-3">
        Mangrove Interaction:
        <input
          type="text"
          name="mangroveInteraction"
          value={formData.mangroveInteraction}
          onChange={handleChange}
          className="w-full p-2 mt-1 border rounded"
        />
      </label>
...
export default TourismIndustryRegistrationForm;
